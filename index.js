...
const Forum1 = require('./src/models/Forum1.js');
const Forum2 = require('./src/models/Forum2.js');
const Forum3 = require('./src/models/Forum3.js');
const router = require('./src/routes/router.js');
const register = require('./src/routes/register.js');
const login = require('./src/routes/login.js');
const changePage = require('./src/routes/changePage.js');
const forum1_create = require('./src/routes/forum1_create.js');
const forum2_create = require('./src/routes/forum2_create.js');
const forum3_create = require('./src/routes/forum3_create.js');
